...
import { FiveElementsRadar, FiveElementsBar, FiveElementsPentagon } from "@/components/charts/FiveElementsCharts";
    ...
    <div className="min-h-screen bg-[#faf8f4] text-stone-800 font-serif print:bg-white">
      ...
      <Section num="Ⅱ" title="五行分析彩图" en="Di Tian Sui · Five Elements">
        <div className="grid grid-cols-2 gap-6 mb-10">
          <FiveElementsRadar wuxingData={d.wuxingDistribution} dayMasterWuxing={d.dayMaster.wuxing} />
          <FiveElementsBar wuxingData={d.wuxingDistribution} dayMasterWuxing={d.dayMaster.wuxing} />
        </div>
        <div className="mb-10" style={{maxWidth:440,margin:"0 auto"}}>
          <FiveElementsPentagon dayMasterWuxing={d.dayMaster.wuxing} />
        </div>
